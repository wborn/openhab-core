...
public class ConfigDescriptionI18nUtil {
    ...
    public @Nullable String getParameterPattern(@Nullable Bundle bundle, URI configDescriptionURI, String parameterName,
    ...
    public @Nullable String getParameterDescription(@Nullable Bundle bundle, URI configDescriptionURI,
            String parameterName, @Nullable String defaultDescription, @Nullable Locale locale) {
    ...
    public @Nullable String getParameterLabel(@Nullable Bundle bundle, URI configDescriptionURI, String parameterName,
    ...
    public @Nullable String getParameterOptionLabel(@Nullable Bundle bundle, URI configDescriptionURI,
            String parameterName, @Nullable String optionValue, @Nullable String defaultOptionLabel,
    ...
    public @Nullable String getParameterUnitLabel(@Nullable Bundle bundle, URI configDescriptionURI,
            String parameterName, @Nullable String unit, @Nullable String defaultUnitLabel, @Nullable Locale locale) {
